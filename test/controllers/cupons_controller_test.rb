...
class CuponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cupon" do
    assert_difference('Cupon.count') do
      post cupons_url, params: { cupon: { amount: @cupon.amount, order_id: @cupon.order_id, used: @cupon.used } }
    end
  ...
  test "should update cupon" do
    patch cupon_url(@cupon), params: { cupon: { amount: @cupon.amount, order_id: @cupon.order_id, used: @cupon.used } }
